...
$token = "5873200327:AAGyYCT0MZfLarxpczgrTFxly4LnbRhS45w";
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>'⇜ أهــــــلاً و ســـهلاً بك في مصنع Silvana🦋

☆︙بوتاتــنا مخصصة لحــماية الكروبــات

☆︙قفل الدردشه و فتحها

☆︙منع الروابط و المعرفات
...
☆︙حذف البوتات
☆︙المطور ← [$name](tg://user?id=$from_id)
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'انشاء بوت  ','callback_data'=>'maka']],
[
